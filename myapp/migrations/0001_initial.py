# Generated by Django 2.2.4 on 2021-01-14 08:01
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('proj_close_date', models.DateField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('neighborhood_id', models.CharField(blank=True, max_length=100, null=True)),
                ('isactive', models.IntegerField(default=1)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('proj_dimension', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='proj_dimension', to='myapp.TerritorialDimension')),
                ...
                ('territorial_dimension', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='territorial_dimension', to='myapp.TerritorialDimension')),
            ],
            options={
                'db_table': '"opx"."task"',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('survery_observation', models.CharField(blank=True, max_length=1000, null=True)),
                ('instrument', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='myapp.Instrument')),
                ('person', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='myapp.Person')),
